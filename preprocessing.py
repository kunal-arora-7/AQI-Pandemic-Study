...
# meteorological factors), and outputs a clean dataset as 'compiled_data_year.csv'.
...
for year in years:
    ...
    # Function extracting variable mean data from a variable csv (every file apart from AQI csv)
